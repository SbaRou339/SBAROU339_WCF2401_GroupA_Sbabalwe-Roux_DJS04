...
class BookApp {
  ...
  setupEventListeners() {
    ...
    document
      ...
      .addEventListener("submit", this.handleThemeChange.bind(this));
    document
      .querySelector("[data-search-form]")
      .addEventListener("submit", this.handleSearch.bind(this));
    document
      .querySelector("[data-list-button]")
      .addEventListener("click", this.showMoreBooks.bind(this));

    document
      .querySelector("[data-list-items]")
      .addEventListener("click", this.showBookPreview.bind(this));
  ...
  handleSearch(event) {
    ...
    document
      ...
      .classList.toggle("list__message_show", this.matches.length < 1);
